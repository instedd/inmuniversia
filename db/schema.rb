...
ActiveRecord::Schema.define(:version => 20130716135636) do
  ...
  add_index "channels", ["address", "verification_code"], :name => "index_channels_on_address_and_verification_code", :unique => true
