...
class VaccinesControllerTest < ActionController::TestCase
  ...
  test "should create vaccine" do
    assert_difference('Vaccine.count') do
      post :create, vaccine: { description: @vaccine.description, name: @vaccine.name, photo: @vaccine.photo, vaccine_type: @vaccine.vaccine_type }
    end
  ...
  test "should update vaccine" do
    put :update, id: @vaccine, vaccine: { description: @vaccine.description, name: @vaccine.name, photo: @vaccine.photo, vaccine_type: @vaccine.vaccine_type }
    assert_redirected_to vaccine_path(assigns(:vaccine))
  end
